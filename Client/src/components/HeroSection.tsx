  ...
  return (
    <div className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-cyan-50/30 to-indigo-50/40">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-tl from-cyan-400/20 to-slate-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        {/* Floating book icons */}
        <div className="absolute top-32 right-1/4 opacity-10 animate-bounce" style={{ animationDuration: '3s', animationDelay: '0.5s' }}>
        ...
        <div className="absolute bottom-40 left-1/4 opacity-10 animate-bounce" style={{ animationDuration: '4s', animationDelay: '1.5s' }}>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        {/* Description */}
        <p className="text-lg md:text-xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          Immerse yourself in a world of stories, knowledge, and imagination. 
          Explore thousands of books across every genre and discover your next favorite read.
        </p>
        ...
        {/* Stats or features */}
        <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
          <div className="group">
            <div className="p-6 bg-white/60 backdrop-blur-md border border-indigo-200/50 rounded-2xl hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              <div className="text-sm text-slate-600 font-semibold">Books Available</div>
            </div>
          </div>
          ...
          <div className="group">
            <div className="p-6 bg-white/60 backdrop-blur-md border border-cyan-200/50 rounded-2xl hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              <div className="text-sm text-slate-600 font-semibold">Happy Readers</div>
            </div>
          </div>
